...
nonisolated enum CLIAgent: String, CaseIterable, Identifiable, Codable, Sendable {
    ...
    var color: Color {
        switch self {
        case .claudeCode: return Color(hex: "D97706")
        case .codexCLI: return Color(hex: "10A37F")
        case .geminiCLI: return Color(hex: "4285F4")
        case .ampCLI: return Color(hex: "FF5543")
        case .openCode: return Color(hex: "8B5CF6")
        case .factoryDroid: return Color(hex: "238636")
        }
    }
}
