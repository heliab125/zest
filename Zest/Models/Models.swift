...
nonisolated enum AIProvider: String, CaseIterable, Codable, Identifiable {
    ...
    var color: Color {
        ...
        case .qwen: return Color(hex: "7C3AED")
        case .iflow: return Color(hex: "06B6D4")
        case .antigravity: return Color(hex: "EC4899")
        case .vertex: return Color(hex: "EA4335")
        case .kiro: return Color(hex: "9046FF")
        case .copilot: return Color(hex: "238636")
        case .cursor: return Color(hex: "00D4AA")
        case .trae: return Color(hex: "00B4D8")
        case .glm: return Color(hex: "3B82F6")
        case .warp: return Color(hex: "01E5FF")
        }
    }
...
nonisolated extension Color {
    /// Creates a Color from a hex string. Non-failable version.
    /// Falls back to black if the hex string is invalid.
    init(hex: String) {
