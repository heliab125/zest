...
enum CustomProviderType: String, CaseIterable, Codable, Identifiable, Sendable {
    ...
    var color: Color {
        switch self {
        case .openaiCompatibility: return Color(hex: "10A37F")
        case .claudeCompatibility: return Color(hex: "D97706")
        case .geminiCompatibility: return Color(hex: "4285F4")
        case .codexCompatibility: return Color(hex: "10A37F")
        case .glmCompatibility: return Color(hex: "3B82F6")
        }
    }
